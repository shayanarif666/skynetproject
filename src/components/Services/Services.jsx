                    ...
                    <div className="lg:flex g-4">
                        ...
                        <div className="service_detail_before_effect w-full lg:w-3/5">
                            ...
                            <motion.div viewport={{ once: true }} initial={{ x: "300px", opacity: 0 }} whileInView={{ opacity: 1, transition: { duration: 1 }, x: 0 }} className="service-detail mb-4 bg-[#070b30] px-[4rem] py-[3rem] relative overflow-hidden w-full z-[999] hover:w-[60vw] cursor-pointer">
                                ...
                                <p className='text-white font-semibold text-lg mt-8'>Across all platforms, we provide flawless user experiences. Your website will not only meet but beyond user expectations thanks to our responsive designs, which seamlessly adjust to any screen size. Regardless of how a visitor arrives at your website, we guarantee a consistent, captivating experience from strategy to design and production.</p>
