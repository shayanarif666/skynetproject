                    ...
                    <div className="row flex items-center">
                        <div className="col-lg-6">
                            <div className="subscribe-form">
                                ...
                                <p className='text-white text-2xl lg:text-3xl font-bold my-4'><em className='text-sky-500'>Subscribe</em> the Top Digital Trends Shaping Branding & Web Design</p>
