                    ...
                    <div className="row g-5">
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">01</div>
                        ...
                        <div className="col-lg-6 ">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">02</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">03</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">04</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">05</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">06</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">07</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-bold text-3xl me-3 text_gradient">08</div>
                                <div className="features_section_content_description">
