...
const Features = ({
    ...
    return (
        <>
            <section id="features_section" className='bg-white py-20'>
                <div className="container">
                    <div className="row mb-20">
                        <div className="col-5">
                            <div className="features-section_title">
                                <h1 className='text-5xl font-bold leading-tight text-sky-950'>Why Choose <span className='text_gradient'>Professional</span> Web Design Company?</h1>
                            </div>
                        </div>
                        {/* <div className="col-4" style={{ background: "url('https://www.digitalsilk.com/wp-content/uploads/2024/09/image-104-1.png.webp')"}}>
                        </div> */}
                    </div>
                    <div className="row g-5">
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">01</div>
                        ...
                        <div className="col-lg-6 ">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">02</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">03</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">04</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">05</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">06</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">07</div>
                                <div className="features_section_content_description">
                        ...
                        <div className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter font-semibold text-3xl me-3 text_gradient">08</div>
                                <div className="features_section_content_description">
