                        ...
                        <div className="pricing_package_features_list mt-14 shadow-md">
                            <div className="pricing_package_select_feature  bg-gradient-to-r from-[rgba(15,73,144,1)] to-[rgba(70,35,134,1)] p-10">
                                <div className="row g-4 flex items-center justify-between">
                                    <div className="service_type col-sm-6 ">
                                        ...
                                        <select
                                            ...
                                            <option hidden selected>Select Category</option>
                                            {
                                                categories?.map(({ _id, slug, name }) => (
                                                    <option value={slug} key={_id}>{name}</option>
                                                ))
                                            }
                                        </select>
                                    </div>
                            ...
                            <div className="pricing_package_check_list  bg-[#131848] py-10 px-sm-14 px-10">
                                ...
                                <h2 className='text-white text-3xl font-bold mb-14'>Informational Website Quote Calculator</h2>
                                ...
                                <div className="pricing_package_check_list_box mb-[1rem] border-b-[1px] border-b-[#1092fd] border-dashed row flex items-center">
                                    <div className="feature_button order-2 order-md-1 col-6 col-md-2 col-xl-1">
                                        <Space direction="vertical">
                                            <Switch checkedChildren="Yes" unCheckedChildren="No" defaultChecked />
                                        </Space>
                                    </div>
                                    <div className="feature_text rder-1 order-md-2 col-12 col-md-7 col-xl-8">
                                        <h3 className='text-white text-xl font-semibold'>Site Planning</h3>
                                    </div>
                                    <div className="feature_price order-3 col-6 col-md-3 flex items-center p-[16px] justify-between">
                                        <div className="hours me-10 w-[50%] text-center">
                                            <h5 className='text-white text-xl font-semibold '>15</h5>
                                        </div>
                                        <div className="price w-[50%] text-center">
                                            <h5 className='text-white text-xl font-semibold'>$1000</h5>
                                        </div>
                                    </div>
                                </div>
                                <div className="pricing_package_check_list_box mb-[1rem] border-b-[1px] border-b-[#1092fd] border-dashed row flex items-center">
                                    ...
                                    <div className="feature_text order-1 order-md-2 col-12 col-md-7 col-xl-8">
                                        <h3 className='text-white text-xl font-semibold'>Each Unique Landing Page Design & Development</h3>
                                    </div>
                                    <div className="feature_price order-3 col-6 col-md-3 flex items-center p-[16px] justify-between">
                                        <div className="hours me-10 w-[50%] text-center">
                                            <h5 className='text-white text-xl font-semibold'>125</h5>
                                        </div>
                                        <div className="price w-[50%] text-center">
                                            <h5 className='text-white text-xl font-semibold'>$825.00</h5>
                                        </div>
                                    </div>
                                </div>
                                <div className="pricing_package_check_list_box mb-[1rem] border-b-[1px] border-b-[#1092fd] border-dashed row flex items-center">
                                    ...
                                    <div className="feature_text order-1 order-md-2 col-12 col-md-7 col-xl-8">
                                        <h3 className='text-white text-xl font-semibold'>Onsite Optimization</h3>
                                    </div>
                                    <div className="feature_price order-3 col-6 col-md-3 flex items-center p-[16px] justify-between">
                                        <div className="hours me-10 w-[50%] text-center">
                                            <h5 className='text-white text-xl font-semibold'>125</h5>
                                        ...
                                        <div className="price w-[50%] text-center">
                                            <h5 className='text-white text-xl font-semibold'>$150.00</h5>
                                        </div>
                                    </div>
                                </div>
                                <div className="pricing_package_check_list_box mb-[1rem] border-b-[1px] border-b-[#1092fd] border-dashed row flex items-center">
                                ...
                                <div className="pricing_package_check_list_total row flex items-center justify-between mt-10">
                                    <div className="total_title col-6">
                                        <h1 className='text-[#fff] text-3xl font-bold me-10'>Estimated Price:</h1>
                                    </div>
                                    <div className="total_prize col-6 justify-end flex items-center">
                                        <h2 className='text-[#04e4ff] text-2xl font-bold me-10'>200h</h2>
                                        <h2 className='text-[#04e4ff] text-2xl font-bold'>$29,000</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
