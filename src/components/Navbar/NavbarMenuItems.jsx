        ...
        <ul className='list-none w-full'>
          ...
          <li className='relative'>
            <a
              ...
              className={`active_menu_link nav_menu_link text-[#eee] pt-[.7rem] lg:py-[.7rem] text-center flex items-center text-[1.5rem] lg:text-[2rem] uppercase font-bold tracking-[1px] transition-all duration-300 hover:text-[#04e4ff]`}
              style={{ "--i": "0.05s" }}
            >
          ...
          <li>
            <a href="/coming-soon" style={{ "--i": "0.35s" }} className='nav_menu_link text-[#eee] py-[.7rem] inline-block text-[1.5rem] lg:text-[2rem] uppercase font-bold tracking-[1px] transition-all duration-300 hover:text-[#04e4ff]'>Contact</a>
          </li>
