            ...
            <section id="features_section" className='py-20 bg-white'>
                <div className="container">
                    <div className="row mb-20">
                        <motion.div initial={{ x: "-200px", opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1, transition: { duration: 1 }, x: 0 }} className="col-xl-5 col-lg-6">
                    ...
                    <div className="row gy-5">
                        <motion.div initial={{ x: "-200px", opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1, transition: { duration: 1 }, x: 0 }} className="col-lg-6">
                        ...
                        <motion.div initial={{ x: "-200px", opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1, transition: { duration: 1, delay: .2 }, x: 0 }} className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter">
                        ...
                        <motion.div initial={{ x: "-200px", opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1, transition: { duration: 1, delay: .3 }, x: 0 }} className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter">
                        ...
                        <motion.div initial={{ x: "-200px", opacity: 0 }} viewport={{ once: true }} whileInView={{ opacity: 1, transition: { duration: 1, delay: .4 }, x: 0 }} className="col-lg-6">
                            <div className="features_section_content flex">
                                <div className="features_section_content_counter">
